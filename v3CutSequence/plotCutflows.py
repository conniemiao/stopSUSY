...
# displayMode, findingSameFlavor, muPreference
# True displayMode displays rather than saves w/o displaying the hists.
# Draws the cutflow for some channel.
...
assert len(sys.argv) == 4, "needs 3 command line args: displayMode{0,1}, findingSameFlavor{0,1}, muPreference{0,1}"
